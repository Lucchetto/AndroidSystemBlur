        ...
        if (a != null) {
            ...
            val cornerRadius = CornersRadius(
                formatEdgeCornerRadius(
                    ...
                    a.getDimensionPixelSize(R.styleable.WindowBlurFrameLayout_cornerRadiusTopLeft, -1)
                ),
                formatEdgeCornerRadius(
                    allEdgesCornerRadius,
                    a.getDimensionPixelSize(R.styleable.WindowBlurFrameLayout_cornerRadiusTopRight, -1)
                ),
                formatEdgeCornerRadius(
                    allEdgesCornerRadius,
                    a.getDimensionPixelSize(R.styleable.WindowBlurFrameLayout_cornerRadiusBottomLeft, -1)
                ),
                formatEdgeCornerRadius(
                    allEdgesCornerRadius,
                    a.getDimensionPixelSize(R.styleable.WindowBlurFrameLayout_cornerRadiusBottomRight, -1)
                )
            )
